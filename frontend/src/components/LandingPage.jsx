...
export default function LandingPage({ claims, loading, onEnter }) {
  ...
  return (
    <div className="h-screen w-full bg-slate-50 text-slate-800 overflow-y-auto font-sans antialiased selection:bg-teal-500/20 scroll-smooth">
      ...
      <nav className="w-full bg-white/90 backdrop-blur-md border-b border-slate-200 sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            ...
            <span className="font-black text-[#0A4D3C] text-2xl tracking-tighter lowercase mt-1">hakiki</span>
          </div>
          <div className="flex items-center gap-6">
            <a href="#how-it-works" className="text-sm font-medium text-slate-500 hover:text-teal-600 transition-colors hidden sm:block">
              How it Works
            </a>
            <button onClick={onEnter} className="text-sm font-bold text-[#1565C0] hover:text-blue-800 transition-colors">
              Open Workspace &rarr;
            </button>
          </div>
        </div>
      ...
      <div className="flex flex-col items-center justify-center px-4 sm:px-6 pt-16 sm:pt-24 pb-16 max-w-5xl mx-auto animate-fade-in min-h-[90vh]">
        ...
        <div className="flex flex-col md:flex-row items-center gap-4 mb-4">
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col justify-center text-left">
              <span className="text-4xl sm:text-5xl font-black tracking-tighter text-[#0A4D3C] lowercase mt-1">
                hakiki
              </span>
            </div>
          </div>
          ...
          <div className="flex flex-col text-center md:text-left text-xs sm:text-sm font-medium text-slate-500">
            <span className="text-slate-800 font-bold">AI-Powered Claims</span>
        ...
        <div className="text-center space-y-5 max-w-4xl mx-auto mt-4">
          <h1 className="text-3xl sm:text-5xl md:text-6xl font-extrabold tracking-tight text-slate-900 leading-[1.15]">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#1565C0] to-[#00897B]">Intelligence, Not More Paperwork.</span>
          </h1>
      ...
      <div id="how-it-works" className="w-full bg-slate-100/60 py-20 sm:py-24 px-4 sm:px-6 border-y border-slate-200">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12 sm:mb-16 px-4">
            <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mb-4">How Hakiki Works</h2>
              ...
              >
                ...
                <div className="relative z-10 flex flex-col h-full">
                  <div className="flex items-center justify-between mb-6">
                    <div className="h-12 w-12 rounded-xl bg-slate-50 text-teal-600 flex items-center justify-center group-hover:scale-110 transition-transform duration-300 shrink-0">
                      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        {step.icon}
                      </svg>
                    </div>
                    <span className="text-4xl sm:text-5xl font-black text-slate-200 group-hover:text-slate-100 transition-colors duration-300">{step.n}</span>
                  </div>
